...
export const PERSONAS = [
  { key: 'popcorn',   nick: '라이트유저',        note: '가볍게 즐기는 편. 극장 경험·상영관 얘기를 자주 함' },
  { key: 'binge',     nick: '정주행요정',    note: '밤새 몰아보기. 1화 진입장벽·페이스 얘기를 잘함' },
  { key: 'dawn',      nick: '새벽반',    note: '잔잔한 감성물 취향. 음악·엔딩 여운 위주' },
  ...
  { key: 'theater',   nick: 'cgvip',        note: '아이맥스·스크린엑스 등 포맷 비교를 즐김' },
  { key: 'complete',  nick: '완결정주행',    note: '완결 난 작품만 몰아봄. 총평형 글' },
  { key: 'murim',     nick: '무협충',      note: '무협 웹툰·웹소설 전문. 원작 비교 자주' },
  { key: 'romcom',    nick: '로코추천좀',      note: '로맨스/로코 취향. 케미·설렘 포인트 위주' },
  { key: 'horror',    nick: '공포찐',        note: '공포·스릴러 마니아. 고어 수위 언급' },
  { key: 'meme',      nick: '예능노잼',  note: '예능 위주. 짤·유행어 반응' },
  { key: 'toon',      nick: '웹툰주7회',    note: '웹툰 연재 따라감. 작화·연출 얘기' },
  { key: 'docu',      nick: '다큐멘터리',      note: '다큐·실화 기반 작품 선호. 담백한 문체' },
  { key: 'season2',   nick: '시즌2기다림',   note: '시즌제 드라마 팬. 다음 시즌 기대·불안' },
  { key: 'netflix',   nick: '넷플뒤적',      note: 'OTT 신작 탐색형. 짧게 여러 편 언급' },
  { key: 'director',  nick: '예비감독',        note: '연출·촬영 얘기를 좋아함. 감독 필모 비교' },
  { key: 'actorfan',  nick: '캐스팅담당자',        note: '연기·캐스팅 중심으로 봄' },
  { key: 'allnight',  nick: '매일밤샘',      note: '즉흥적이고 짧은 감상평. 반응이 빠름' },
]
